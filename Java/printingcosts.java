...
public class printingcosts {
  public static void main(String[] args) throws IOException {
    ...
    PrintWriter text = new PrintWriter(new BufferedWriter(new OutputStreamWriter(System.out)));

    int[] costs = {0, 9, 6, 24,29,22, // SPACE, !, ", #, $, %
                   24,3, 12,12,17,13, // &, ', (, ), *, +
                   7, 7, 4, 10,22,19, // ,, -, ., /, 0, 1
    ...
    while((line = in.readLine()) != null) {
        ...
        for(int i = 0; i < line.length(); i++) {
            totalCost += costs[line.charAt(i) - 32];
        }
        text.println(totalCost); 
    }
    text.close();
  }
}
